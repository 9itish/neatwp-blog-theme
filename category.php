...
<h1 class="post-list-heading">
    ...
    printf( esc_html__( 'Category Archives: %s', 'neatwp-blog-theme' ), esc_html( $tag_name ) );
    ?>
</h1>
...
<main id="main-content" class="category-posts n-flex <?php echo $archive_layout == 'grid' ? 'n-flex-aw-112' : 'n-gap-x4' ?>">
